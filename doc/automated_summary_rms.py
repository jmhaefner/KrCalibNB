...
vals_file_location = vals_file_location+str(run_number)+'z_rms'+'/vals_'+str(run_number)+'.txt'
...
template_location = '/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/slides/runTPLT_RMS.tex'
...
# Save the new file
output_location = '/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/slides/run'+str(run_number)+'_rms.tex'
output = open(output_location, "w")
output.write(mod_contents)
output.close()

# Duplicate the krCalib template with the correct run number
wrap_template_location = '/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/krCalib_TPLT_RMS.tex'
...
wrap_template.close()
wrap_output_location = '/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/krCalib_'+str(run_number)+'_rms.tex'
