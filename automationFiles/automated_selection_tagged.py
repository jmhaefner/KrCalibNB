...
for run_number in range(run_min, run_max):
    ...
    try:
        ...
        flex_nb_location = "/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/automationFiles/kr_selection_and_filter_"+tag+"_TPLT.ipynb"
        ...
        try:
            summary_directory = "/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/img/r"+str(run_number)+'_'+tag+"/"
