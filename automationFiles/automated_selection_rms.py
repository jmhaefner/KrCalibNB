...
for run_number in range(run_min, run_max):
    ...
    try:
        ...
        flex_nb_location = "/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/automationFiles/kr_selection_and_filter_RMS_TPLT.ipynb"
        ...
        mod_contents = mod_contents.replace("<ANALYSIS_TAG>", 'z_rms')
        flex_nb.close()

        # make the output folder for the summary
        try:
            summary_directory = "/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/doc/img/r"+str(run_number)+'z_rms'+"/"
        ...
        out_nb_location = out_nb_prefix+str(run_number)+"_z_rms.ipynb"
