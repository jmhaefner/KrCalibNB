...
for run_number in found_runs:
    ...
    try:
        ...
        flex_nb_location = "/Users/jmhaefner/Development/KryptonCalibration/KrCalibNB_JMH/KrCalibNB/automationFiles/single_map_correction_RMS_TPLT.ipynb"
        ...
        out_nb_location = out_nb_prefix+run_number+"_z_rms.ipynb"
